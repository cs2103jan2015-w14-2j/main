...
public class FileStorageDemo {
    ...
    static Command command1 = new Command(task1, CommandType.ADD); // Add
                                                                   // command
                                                                   // for Task1

    static Command command2 = new Command(task2, CommandType.ADD); // Add
                                                                   // command
                                                                   // for Task2

    static Command command3 = new Command(task3, CommandType.ADD); // Add
                                                                   // Command
                                                                   // for Task3
    ...
    public static void main(String args[]) {
        ...
        // Delete Task 1
        Command command4 = new Command(listTask.get(0), CommandType.DELETE);
        ...
        Command command5 = new Command(listTask.get(0), CommandType.DELETE);
        ...
        Command command6 = new Command(listTask2.get(1), CommandType.DELETE);
        ...
        */
        ...
        Command command9 = new Command(toEdit, CommandType.EDIT);
